...
from port.adapter.service.item.image.adapter.estimator import EstimatorImageTypeAdapter
from port.adapter.service.item.image.adapter.fashionclip import FashionClipAdapter
